...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { author: @slide.author, body: @slide.body, deleted_at: @slide.deleted_at, title: @slide.title }
    end
  ...
  test "should update slide" do
    put :update, id: @slide, slide: { author: @slide.author, body: @slide.body, deleted_at: @slide.deleted_at, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
